...
export default function SidebarTecnico({ sidebarOpen, setSidebarOpen }) {
  ...
  const menuSections = [
    {
      title: "Core",
      items: [
        { label: "Dashboard", icon: "fa-gauge-high", path: "/dashboard/tecnico" },
      ],
    },
    {
      title: "Operações",
      items: [
        { label: "Equipamentos", icon: "fa-gears", path: "/dashboard/tecnico/equipamentos" },
        { label: "Manutenções", icon: "fa-screwdriver-wrench", path: "/dashboard/tecnico/manutencoes" },
        { label: "Ocorrências", icon: "fa-triangle-exclamation", path: "/dashboard/tecnico/ocorrencias" },
      ],
    },
    {
      title: "Sistema",
      items: [
        { label: "Configurações", icon: "fa-gear", path: "/dashboard/tecnico/configuracoes" },
      ],
    },
  ];
