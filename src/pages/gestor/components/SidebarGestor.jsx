...
export default function SidebarGestor({ sidebarOpen, setSidebarOpen }) {
  ...
  const menuSections = [
    {
      title: "Core",
      items: [
        { label: "Dashboard", icon: "fa-gauge-high", path: "/dashboard/gestor" },
      ],
    },
    {
      title: "Operações",
      items: [
        { label: "Equipamentos", icon: "fa-gears", path: "/dashboard/gestor/equipamentos" },
      ],
    },
    {
      title: "Gestão",
      items: [
        { label: "Relatórios", icon: "fa-file-lines", path: "/dashboard/gestor/relatorios" },
        { label: "Indicadores", icon: "fa-chart-line", path: "/dashboard/gestor/indicadores" },
      ],
    },
    {
      title: "Sistema",
      items: [
        { label: "Configurações", icon: "fa-gear", path: "/dashboard/gestor/configuracoes" },
      ],
    },
  ];
