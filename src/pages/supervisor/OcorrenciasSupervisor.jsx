...
export default function OcorrenciasSupervisor() {
  ...
  return (
    <>
      ...
      <SupervisorLayout title="Ocorrências">
          ...
          <div className="bg-white p-1">
            <form onSubmit={(e) => e.preventDefault()} className="space-y-6 p-2">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="Ex: Compressor de Air Comprimido N3"
                ...
                {/* Estado Interno (Apenas visível em modo Edição para o Supervisor alterar progresso) */}
                {modoEdicao && (
                  <div>
                    <label className="block mb-2 text-xs uppercase font-black tracking-wider text-green-900">
        ...
        >
          <div className="p-1 space-y-4 text-center sm:text-left">
            <p className="text-slate-600 text-sm leading-relaxed">
              ...
              foi totalmente retificada com sucesso e o ativo pode voltar a operar em segurança?
            </p>
