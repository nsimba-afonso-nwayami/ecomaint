...
export default function ManutencaoSupervisor() {
  ...
  return (
    <>
      ...
      <SupervisorLayout title="Manutenções">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-6 p-2">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    <i className="fa-solid fa-circle-裂 absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-sm"></i>
                    <select 
        ...
        >
          <div className="p-1 space-y-4 text-center sm:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              ...
              <button
                onClick={() => {
                  // Lógica de exclusão da manutenção aqui
